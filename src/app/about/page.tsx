...
export default function AboutPage() {
  return (
    <FadeIn duration={800}>
      <main className="flex flex-col items-center justify-start min-h-[70vh] text-left pt-20 sm:pt-24 pb-16 sm:pb-20">
        <div className="max-w-6xl w-full mx-auto px-4 sm:px-6 md:px-8">

          {/* Header Section */}
          <div className="mb-6 sm:mb-8 fade-in">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-light tracking-tight text-pink">about</h1>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-12">
            ...
            <div className="space-y-12">
              ...
              <section className="fade-in" style={{ animationDelay: '100ms' }}>
                <div className="flex flex-col sm:flex-row items-start gap-8">
                  ...
                  <div className="text-gray-300 leading-relaxed space-y-4 text-lg font-light">
                    ...
                    <p>
                      what excites me most is <span className="text-green font-medium">rapid prototyping</span>&mdash;taking ideas from concept to deployed product by learning new frameworks quickly and iterating fast. whether it&apos;s building multi-agent ai systems, integrating blockchain, or training ml models for production, i thrive on projects that push technical boundaries.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section className="fade-in" style={{ animationDelay: '200ms' }}>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <ProjectCard
                    title="opal"
                    color="text-peach"
                    description="discord ai agent that controls a real chrome browser via voice and text commands with real-time vision."
                    tech={["React", "FastAPI", "Discord.py", "LiveKit"]}
                  />
                  <ProjectCard
              ...
              <section className="fade-in" style={{ animationDelay: '300ms' }}>
                ...
                <div className="space-y-8 border-l-2 border-white/15 pl-8 relative">
                  <ExperienceItem
              ...
              <section className="fade-in" style={{ animationDelay: '500ms' }}>
               ...
               />
                   ...
                   <Link href="/projects" className="mt-2 inline-block text-peach hover:text-white transition-colors text-sm group">
                     View all projects <span className="inline-block transition-transform group-hover:translate-x-1">&rarr;</span>
                   </Link>
                </div>
              </section>
          ...
          <div className="mt-16 fade-in text-center" style={{ animationDelay: '1000ms' }}>
            <Link href="/" className="text-sm text-gray-500 hover:text-white transition-colors">&larr; Back to Home</Link>
          </div>
        </div>
      </main>
    </FadeIn>
  ...
  return (
    ...
    <Wrapper {...props} className="block group p-4 rounded-xl bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/10 transition-all duration-300 h-full flex flex-col">
      <div className="flex justify-between items-start mb-2">
        ...
        {href ? <span className="text-gray-500 group-hover:text-white transition-colors text-xs">&nearr;</span> : null}
      </div>
...
function ExperienceItem({ role, company, companyColor, period, bullets }: { role: string, company: string, companyColor: string, period: string, bullets: string[] }) {
  return (
    <div className="relative group">
      {/* Timeline Dot */}
      <div className="absolute -left-[43px] top-1 h-6 w-6 rounded-full border-4 border-black bg-gray-600 group-hover:bg-white transition-colors duration-300"></div>
